...
class SportsCar {
    ...
    // charactersistics of a SportsCar
    // We make these variables private to restrict direct access from outside the class.
    // This is how we provide data security.
    // We can access these variables only through methods of this class.
    // This is called encapsulation.
    // We can also use getters and setters to access these variables.
    // In this example, we will use getters to access the variables.
    // We will not use setters to change the values of these variables directly.
    // Instead, we will use methods to change the values of these variables.
    // This is to show how encapsulation works in real world.
